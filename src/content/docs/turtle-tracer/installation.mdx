---
title: Installation
description: How to install TurtleTracer on macOS, Windows, and Linux for FTC path planning.
head:
  - tag: meta
    attrs:
      name: keywords
      content: install TurtleTracer, macOS, Windows, Linux, FTC path planning tools
---

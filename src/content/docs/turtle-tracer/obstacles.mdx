...
A **Keep-In Zone** is a special type of obstacle. Instead of forcing the path _around_ the defined area, the path optimizer and validation system will require the robot to stay strictly _inside_ the defined boundaries of a keep-in zone.

...
description: New here? Learn the basics of using the TurtleTracer, the modern path planner for FTC.
head:
  - tag: meta
    attrs:
      name: keywords
      content: TurtleTracer, FTC path planner, autonomous trajectory generator, FTC robotics interface
---

# Getting Started

Welcome to Matthew Allen's **TurtleTracer**, the modern path planner for FTC. This guide will get you up and running in minutes.

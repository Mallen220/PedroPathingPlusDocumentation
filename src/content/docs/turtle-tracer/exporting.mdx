...
- **Dynamic Loading**: This mode uses `TurtleTracerPathReader` to load path data from the `.pp` file at runtime. **You must upload your `.pp` file to the robot** for this to work.

---
title: Live View
description: Learn how to stream real-time robot telemetry to the TurtleTracer.
head:
  - tag: meta
    attrs:
      name: keywords
      content: TurtleTracerLiveView, FTC live view, real-time telemetry, robotics, robot pose streaming
---

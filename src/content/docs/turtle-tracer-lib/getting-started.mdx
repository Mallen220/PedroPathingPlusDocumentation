...
<Tabs>
   <TabItem label="Standard OpMode (Default)">
    ...
    import com.turtletracer.geometry.BezierCurve;
    ...
    public class TurtleTracerLibAutonomous extends OpMode {
      ...
      public Follower follower; // TurtleTracerLib follower instance
      ...
      @Override
      public void loop() {
        follower.update(); // Update TurtleTracerLib
   ...
   <TabItem label="Command-Based (SolversLib)">
    ...
    5.  **Important**: This method typically requires you to save the path file (`.pp`) to your robot's storage as well, as it uses `TurtleTracerPathReader` to load points dynamically.
    ...
    import com.seattlesolvers.solverslib.turtleTracerCommand.FollowPathCommand;
    ...
    -   **`TurtleTracerPathReader`**: Used to load named poses from the saved path file.

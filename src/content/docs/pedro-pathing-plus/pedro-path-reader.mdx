...
description: Learn how to dynamically load path coordinates from .pp files into your FTC robot using PedroPathReader, decoupling path geometry from code to adjust paths without recompiling.
head:
  - tag: meta
    attrs:
      name: keywords
      content: PedroPathingPlus, PedroPathReader, FTC, dynamic loading, path points, .pp files, robotics, JSON file loading, dynamic poses, no recompiling
---

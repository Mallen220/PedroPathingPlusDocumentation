...
description: A comprehensive beginner's guide to creating your first FIRST Tech Challenge (FTC) autonomous program with Pedro Pathing Plus using a visualizer-first workflow.
head:
  - tag: meta
    attrs:
      name: keywords
      content: FTC autonomous program, FIRST Tech Challenge, PedroPathingPlus getting started, visualizer-first workflow, FTC path planning, generate FTC code, how to code autonomous FTC
...
Welcome to Pedro Pathing Plus! This getting started guide will walk you through the essential steps to create your very first autonomous program for your **FIRST Tech Challenge (FTC)** robot. By utilizing our highly recommended visualizer-first workflow, you can design, simulate, and generate complete Java code (both standard OpMode and Command-Based) for your pathing routines without writing complex geometry by hand.

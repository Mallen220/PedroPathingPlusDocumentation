---
title: Getting Started with Pedro Pathing Plus
description: Create your first FIRST Tech Challenge (FTC) autonomous program with Pedro Pathing Plus using our recommended visualizer-first workflow.
head:
  - tag: meta
    attrs:
      name: keywords
      content: FTC autonomous program, PedroPathingPlus getting started, visualizer-first workflow, FTC path planning

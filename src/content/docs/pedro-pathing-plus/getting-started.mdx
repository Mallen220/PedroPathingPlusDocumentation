...
description: Create your first FTC autonomous program with Pedro Pathing Plus. Learn the recommended visualizer-first workflow for designing and exporting efficient paths.
head:
  - tag: meta
    attrs:
      name: keywords
      content: FTC autonomous program, PedroPathingPlus getting started, visualizer-first workflow, FTC path planning, robot trajectory, autonomous routine

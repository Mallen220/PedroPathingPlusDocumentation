...
description: Learn how to use FTC Command-Based programming with PedroPathingPlus for efficient and structured robot code.
head:
  - tag: meta
    attrs:
      name: keywords
      content: PedroPathingPlus, command-based programming, FTC, robotics, WPILib, FTCLib
---

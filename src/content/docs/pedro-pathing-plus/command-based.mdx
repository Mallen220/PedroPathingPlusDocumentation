...
description: Master FTC Command-Based programming with PedroPathingPlus. Learn to structure efficient robot code using commands, subsystems, and the CommandScheduler.
head:
  - tag: meta
    attrs:
      name: keywords
      content: PedroPathingPlus, command-based programming, FTC, robotics, WPILib, FTCLib, FollowPathCommand, CommandScheduler, Subsystem, SequentialCommandGroup
---

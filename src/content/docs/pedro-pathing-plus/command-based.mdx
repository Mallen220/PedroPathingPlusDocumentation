...
description: Learn how to use FTC Command-Based programming with PedroPathingPlus for efficient and structured robot code using CommandScheduler, Subsystems, and FollowPathCommand.
head:
  - tag: meta
    attrs:
      name: keywords
      content: PedroPathingPlus, command-based programming, FTC, robotics, WPILib, FTCLib, CommandScheduler, FollowPathCommand, Subsystem, SequentialCommandGroup
---

PedroPathingPlus includes built-in support for Command-Based programming, allowing you to structure your robot code efficiently using commands and subsystems. This approach is similar to [WPILib](https://docs.wpilib.org/) and [FTCLib](https://docs.ftclib.org/) but tailored specifically for the FTC Pedro Pathing library.

...
head:
  - tag: meta
    attrs:
      name: keywords
      content: PedroPathingPlus, NamedCommands, ProgressTracker, FTC events, robot path sync, robotics, event markers mapping, command execution, synchronize actions
---

---
title: Installation
description: How to install PedroPathingPlus for your FTC project using Android Studio and Gradle.
head:
  - tag: meta
    attrs:
      name: keywords
      content: PedroPathingPlus installation, FTC Android Studio setup, Gradle dependencies, FTC robotics library
---

...
head:
  - tag: meta
    attrs:
      name: keywords
      content: PedroPathingPlus, ProgressTracker, robot progress monitoring, FTC path events, event triggering, robotics, completion percentage, turn progress, execute events
---

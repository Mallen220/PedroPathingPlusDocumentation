...
description: Learn how to use ProgressTracker in PedroPathingPlus to monitor robot path completion, track turns, and automatically trigger FTC autonomous events.
head:
  - tag: meta
    attrs:
      name: keywords
      content: PedroPathingPlus, ProgressTracker, robot progress monitoring, FTC path events, event triggering, robotics, NamedCommands, autonomous turn tracking
---

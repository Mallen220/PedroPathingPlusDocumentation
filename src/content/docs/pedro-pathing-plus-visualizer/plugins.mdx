---
title: Plugins
description: "Extend the Pedro Pathing Plus Visualizer with custom code exporters, UI themes, and plugins for FTC robotics."
head:
  - tag: meta
    attrs:
      name: keywords
      content: PedroPathingPlusVisualizer, custom plugins, exporters, FTC tools, themes, robotics
---

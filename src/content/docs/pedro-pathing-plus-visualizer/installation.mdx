---
title: Installation
description: How to install PedroPathingPlusVisualizer on macOS, Windows, and Linux for FTC path planning.
head:
  - tag: meta
    attrs:
      name: keywords
      content: install Pedro Pathing Visualizer, macOS, Windows, Linux, FTC path planning tools
---

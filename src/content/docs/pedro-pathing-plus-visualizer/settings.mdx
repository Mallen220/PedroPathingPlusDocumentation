---
title: Settings
description: "Customize the Pedro Pathing Plus Visualizer settings to match your FTC robot's physical properties, motion profiles, and code export workflow."
head:
  - tag: meta
    attrs:
      name: keywords
      content: PedroPathingPlusVisualizer, visualizer settings, customize robot workflow, FTC pathing, robotics
---

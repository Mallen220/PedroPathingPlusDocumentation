...
description: "Learn how to organize, save, and load your FTC robotics path planning projects using the Pedro Pathing Plus Visualizer file management system."
head:
  - tag: meta
    attrs:
      name: keywords
      content: PedroPathingPlusVisualizer, file management, FTC projects, save load paths, robotics
---
...
- **Export**: To generate Java code or .PP, use the **Export** button in the main navbar. See [Exporting Code](./exporting/) for details.

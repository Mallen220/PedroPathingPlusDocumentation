...
description: Learn the basics of using the Pedro Pathing Plus Visualizer, the modern path planner for FTC. Design paths visually, optimize routes, and export Java code.
head:
  - tag: meta
    attrs:
      name: keywords
      content: Pedro Pathing Visualizer, FTC path planner, autonomous trajectory generator, FTC robotics interface
---

...
description: Learn the basics of the Pedro Pathing Plus Visualizer. Discover the modern FTC path planner for designing, optimizing, and exporting autonomous routines.
head:
  - tag: meta
    attrs:
      name: keywords
      content: Pedro Pathing Visualizer, FTC path planner, autonomous trajectory generator, FTC robotics interface, robot path optimization, visualizer UI
---
